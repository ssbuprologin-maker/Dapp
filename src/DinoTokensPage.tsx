...
type RewardData = { dinoTokens: number; tokensPerSol: number; leaderboard: { rank: number; wallet: string; network: Network; tokens: number; name: string }[] }
