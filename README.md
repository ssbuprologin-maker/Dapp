# TESTNET GAMES - Dino Run Build V18
...
- PostHog anonymously tracks page/session activity and explicit wallet, payment, and game-result events.
...
## Upstash worldwide leaderboard setup
...
After adding or changing variables, redeploy the newest Production commit. Confirm the game header displays `DUAL TESTNET BOT RACE - BUILD V18`.
